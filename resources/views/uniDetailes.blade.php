          ...
          <div class="row">
            <div class="col-md-6">
              <div class="detail-box ">
                ...
                <p class="sliderBox">Sometime the first step can be the hardest but at AMBITION- your trusted education
                  agent - we make it
                  easy. Chat to our education consultants today and be one of the thousands of students a year we help
            ...
            <div class="col-md-6">
              <div class="row">
                <div class=" col-lg-10 mx-auto">
                  <div class="img-box">
                    <img class="sliderimage" src="{{ asset('images/' . $university->image1) }}" alt="{{ $university->name }}">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="row">
                <div class=" col-lg-10 mx-auto">
                  <div class="img-box">
                    <img class="sliderimage" src="{{ asset('images/' . $university->image2) }}" alt="{{ $university->name }}">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="row">
                <div class=" col-lg-10 mx-auto">
                  <div class="img-box">
                    <img class="sliderimage" src="{{ asset('images/' . $university->image3) }}" alt="{{ $university->name }}">
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="container ">
                <div class="row">
                  ...
                  <div class="col-md-6 col-lg-4">
                      <div class="box">
                          <div>
                              <img class="uni_pict" src="{{ asset('images/' . $college->image) }}" alt="{{ $college->name }}">
                          </div>
                          <div class="detail-box">
                              <h4>{{ $college->name }}</h4>

                              <a href="{{ route('collegeDetailes', ['id' => $college->id, 'uni_id' => $university->id]) }}">
                                See Details
                            </a>
          ...
          <div class="heading_container">         
            <div class="AdmissionRequirements">
              ...
              <ul>
                ...
                <li>The student must have obtained a German language certificate .<a id="lanAc" href="lanAca.php">Language
                    academies</a>
                </li>
              </ul>
            </div>
            <div class="cost">
              ...
              <p>The expected tuition fees for studying at the Berlin University of Technology in Germany are
                equivalent to 350 US dollars, and some major majors may reach 1000 US dollars, and the Berlin
                University of Technology expenses in Germany depend on the required academic specialization.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="detail-box">
          <div class="col-12" id="locationContainer">
            <div class="location">
              ...
              <i class="fas fa-map-marker" style="font-size:20px;color:#db4437;text-shadow:2px 2px 4px #000000;"></i>
            </div>
            <div class="AdmissionRequirements">
              <p><iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d10380.51304685604!2d7.755319600000003!3d49.42538909999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47966d5189fba81f%3A0x8ab04632090ea019!2sRPTU%20Kaiserslautern!5e0!3m2!1sen!2sjo!4v1692810472262!5m2!1sen!2sjo"
...
<!-- <script async defer src="https://www.google.com/maps/place/RPTU+Kaiserslautern/@49.4247406,7.7385309,13.68z/data=!4m14!1m7!3m6!1s0x47966d5189fba81f:0x8ab04632090ea019!2sRPTU+Kaiserslautern!8m2!3d49.4253891!4d7.7553196!16zL20vMGRmMnBm!3m5!1s0x47966d5189fba81f:0x8ab04632090ea019!8m2!3d49.4253891!4d7.7553196!16zL20vMGRmMnBm?entry=ttu"></script> -->
